                    ...
                    <div className='space-y-2 md:space-y-3'>
                        {freeDetails.map((feature, index) => (
                            <div key={index} className="flex items-start text-xs md:text-sm leading-relaxed">
                                {feature.status === true ? (
                                    <Check className="w-3 h-3 md:w-4 md:h-4 text-green-500 mr-2 md:mr-2.5 flex-shrink-0 mt-0.5" />
                                ) : (
                                    <X className="w-3 h-3 md:w-4 md:h-4 text-red-400 mr-2 md:mr-2.5 flex-shrink-0 mt-0.5" />
                                )}
