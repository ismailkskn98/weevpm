                ...
                loading || !userData ? (
                    ...
                    userData.user.active_package == 'PREMIUM' ? (
                        ...
                        <button
                            ...
                            className="w-1/2 3xl:w-2/3 uppercase bg-purple-600 text-white font-medium py-3 3xl:py-3.5 px-6 rounded-3xl text-sm transition-all duration-200 shadow-sm hover:shadow-lg cursor-pointer hover:bg-purple-700"
                        >
                            {t('buyButton')}
                        </button>
                    )
