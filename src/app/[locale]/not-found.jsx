      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-8 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
        ...
        <article className="space-y-6 max-w-2xl mx-auto">
          <div className="space-y-4">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-deep-teal leading-tight">
              Sayfa Bulunamadı
            </h1>
        ...
        <div className="mt-8 opacity-60">
          <div className="flex items-center justify-center space-x-2">
            <div className="w-2 h-2 bg-aqua-green rounded-full animate-bounce"></div>
            <div className="w-2 h-2 bg-teal rounded-full animate-bounce delay-100"></div>
            <div className="w-2 h-2 bg-soft-turquoise rounded-full animate-bounce delay-200"></div>
          </div>
        </div>
      </div>
    </main>
