    ...
    return (
        ...
        >
            <article className='flex flex-col items-center justify-center gap-3 mb-2'>
                <h1 className='text-3xl 2xl:text-4xl 3xl:text-5xl font-bold text-white'>Register</h1>
                <p className='text-sm text-white/80'>Create an account to get started</p>
            </article>
            {/* {referenceInfo && ( */}
            <section className="rounded-full w-full bg-green-900/10 backdrop-blur-md border-2 border-gray-400/10 text-white">
                <article className="flex items-center gap-3 px-3 py-3">
                    ...
                    <div className="flex-1">
                        <p className="text-sm font-medium text-green-400">Referans ile katılıyorsunuz</p>
