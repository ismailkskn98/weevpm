...
export default function HeroContent() {
  ...
  return (
    <article className="relative z-20 flex flex-col items-start gap-4 max-w-sm lg:max-w-md xl:max-w-xl">
      <h1 className="text-4xl xl:text-5xl 2xl:text-6xl font-bold text-black/80 capitalize">{t("hero.title")}</h1>
      <p className="text-sm xl:text-base text-black/80">{t("hero.description")}</p>
