    ...
    return (
        <div className='w-full relative'>
            <div className='relative w-full'>
                ...
                {forgotPassword && <Link href="/auth/forgot-password" className='text-xs text-white/80 absolute underline -bottom-1.5 right-0 translate-y-full'>Password forgotten?</Link>}
                {
                    type === "password" && (
                        <>
