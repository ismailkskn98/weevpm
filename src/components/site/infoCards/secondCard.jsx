...
import SecondCardQR from './secondCardQR'
import { useTranslations } from 'next-intl'

export default function SecondCard() {
    const t = useTranslations('Site.InfoCards.card2')
    return (
        <section className='w-full xl:w-11/12 2xl:w-10/12 mx-auto flex flex-col md:flex-row items-center justify-around  gap-12 md:gap-3 lg:gap-0'>
            <article className='order-2 md:order-1 flex flex-col items-start gap-4 max-w-lg md:max-w-2xl 2xl:max-w-full'>
