        ...
        return (
            <div className="flex items-center justify-center min-h-64 px-4">
                <div className="text-center">
                    ...
                    <h3 className="text-sm sm:text-base font-medium text-gray-900 mb-1">İçerik Bulunamadı</h3>
                    <p className="text-xs sm:text-sm text-gray-500">Aradığınız sayfa mevcut değil.</p>
                </div>
            </div>
        )
    }
